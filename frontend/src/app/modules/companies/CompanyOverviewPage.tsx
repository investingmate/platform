      ...
      <div className="card-body p-5 pt-6 pb-6 mb-xl-10">
        <Accordion defaultActiveKey={['0']} alwaysOpen>
          ...
          <Accordion.Item eventKey="1">
            <Accordion.Header>{intl.formatMessage({id: 'COMPANIES.PRICE_GRAPH'})}</Accordion.Header>
            <Accordion.Body>
              <PriceGraph />
            </Accordion.Body>
          </Accordion.Item>
          <Accordion.Item eventKey="2">
            <Accordion.Header>{intl.formatMessage({id: 'COMPANIES.INDICATORS'})}</Accordion.Header>
            <Accordion.Body>
              <Indicators indicatorsData={company.indicators_group}/>
            </Accordion.Body>
          </Accordion.Item>
          <Accordion.Item eventKey="3">
            <Accordion.Header>{intl.formatMessage({id: 'COMPANIES.DIVIDEND_HISTORY'})}</Accordion.Header>
            <Accordion.Body>
              <DividendHistory />
            </Accordion.Body>
          </Accordion.Item>

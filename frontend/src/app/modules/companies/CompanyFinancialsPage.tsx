      ...
      <div className="card-body p-5 pt-6 pb-6 mb-xl-10">
        <Accordion defaultActiveKey={['0']} alwaysOpen>
          ...
          <Accordion.Item eventKey="1">
            <Accordion.Header>{intl.formatMessage({id: 'COMPANIES.INCOME_STATEMENT'})}</Accordion.Header>
            <Accordion.Body>
              <IncomeStatement />
            </Accordion.Body>
          </Accordion.Item>
          <Accordion.Item eventKey="2">
            <Accordion.Header>{intl.formatMessage({id: 'COMPANIES.BALANCE_SHEET'})}</Accordion.Header>
            <Accordion.Body>
              <BalanceSheet />
            </Accordion.Body>
          </Accordion.Item>

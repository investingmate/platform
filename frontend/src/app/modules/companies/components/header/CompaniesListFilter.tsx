...
const CompaniesListFilter = () => {
  ...
  return (
    <>
      ...
      >
        <IMSVG path='/media/icons/duotune/general/gen031.svg' className='svg-icon-2' />
        Filter
      </button>
      {/* end::Filter Button */}
      {/* begin::SubMenu */}
      <div className='menu menu-sub menu-sub-dropdown w-300px w-md-325px' data-im-menu='true'>
        {/* begin::Header */}
        ...
        <div className='px-7 py-5' data-im-user-table-filter='form'>
          ...
          <div className='mb-10'>
            ...
            <select
              ...
              data-im-select2='true'
              data-placeholder='Select option'
              data-allow-clear='true'
              data-im-user-table-filter='role'
          ...
          <div className='mb-10'>
            ...
            <select
              ...
              data-placeholder='Select option'
              data-allow-clear='true'
              data-im-user-table-filter='two-step'
              data-hide-search='true'
